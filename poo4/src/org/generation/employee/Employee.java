...
/*Abstracción. permite identificar aspectos esecnciales de un objeto y ocultar los detalles irrelevantes o complejos.
 * Permite que los métodos tomen diferentes formas al ser heredadas, usando una plantilla base.
public class 
Interface es un tipo de "clase" que define un conjuunto de métodos que pueden ser implementados por diversas clases
*/
