...
public class FuncionDescuento {
	...
	public static void main(String[] args) {
		...
		double porcentajeDescuento = 15;//obetenr el porcentaje de descuento
		...
		static double calcularDescuento (double precioProducto, double porcentajeDescuento){ // funcion para calcular el total 
...
/* La refactorización es reestructurar código que ya existe sin alterar su comportamiento.Tiene como objetivo mejorar la legibilidad, mantenibilidad y optimizacion de nustro código*/
