...
public class UserController {
	...
	//path variable, ya que buscamos por id y los id son diferentes, entonces necesito definir el endpoint entre llaves y dentro del método debo crear una anotación @PathVariable y poner entre paréntesis un nombre, en este caso ("id")
		@GetMapping("users/{id}") 
...
//DELETE, de tipo void y define un path variable 
	...
	/*¿Cómo agrego usuarios desde Postman?
	 * Tenemos que establcecer el cuerpo de la instancia en formato JSON (key/value) y mandar el método POST*/
	 ...
	 * 		2. Especifica el código de estado HTTP `HttStatus.method`
	...
	//PUT PARA MODIFICAR, ACTUALIZAR A UN USUARIO EXISTENTE
