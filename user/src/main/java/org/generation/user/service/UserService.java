...
/*
	 ...
	 * Emulamos una base de datos utilizando un ArrayList para realizar las operaciones del CRUD aunque solo vamos a realizar Read mediante un protocolo HTTP GET.
	 * Para definir nuestra clase de java como un service, utilizamos la anotación @Service .
	 * 
	 * */
...
public class UserService {	
	...
	// Crear el ArrayList en donde van a vivir todos los usuarios que quieran agregar 
		
	public final List <User> usuario = new ArrayList<>();
	
	// instanciar objetos User en un método constructor llamado UserService
