...
public class Employee {
	...
	// 2. Método constructor (1 - n métodos). Tiene el mismo nombre que la clase, no retorna nada, recibe parámetros (atributos) y los asigna variables del constructor (this).
